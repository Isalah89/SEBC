- ls /etc/yum.repos.d
```
[imene@im2 ~]$ sudo ls /etc/yum.repos.d
...
```
[imene@im2 ~]$ sudo /usr/share/cmf/schema/scm_prepare_database.sh  mysql scm scmuser password -h 172.31.28.11  -P 3306
...
[2018-10-19 08:04:38,227] INFO     0[main] - com.cloudera.enterprise.dbutil.DbCommandExecutor.testDbConnection(DbCommandExecutor.java) - Successfully connected to database.
